...
function spine2_register_sidebars(){
    ...
    register_sidebar(
        array(
            ...
            'name' => __( 'Front Page First Band','spinalfluid' ),
            'description' => __( 'This is the full width area at the top of the Front Page template.','spinalfluid'  ),
    ...
    register_sidebar(
        array(
            ...
            'name' => __( 'Front Page Second Band 1','spinalfluid' ),
            'description' => __( 'This is the narrow area in the middle of the Front Page template.','spinalfluid'  ),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            ...
            'name' => __( 'Front Page Second Band 2','spinalfluid' ),
            'description' => __( 'This is the wider area in the middle of the Front Page template.','spinalfluid'  ),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            ...
            'name' => __( 'Front Page Third Band 1','spinalfluid' ),
            'description' => __( 'This is the wider area at the bottom of the Front Page template.','spinalfluid'  ),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>'
    ...
    register_sidebar(
        array(
            ...
            'name' => __( 'Front Page Third Band 2','spinalfluid' ),
            'description' => __( 'This is the narrow area at the bottom of the Front Page template.','spinalfluid'  ),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title">',
            'after_title' => '</h3>'
